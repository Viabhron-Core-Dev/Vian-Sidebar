...
//         serviceLifecycleOwner = ServiceLifecycleOwner()
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            startForeground(2, notification, foregroundServiceTypes)
        } else {
...
//             floatingView.setViewTreeLifecycleOwner(it)
    ...
    private fun loadBook(bookId: Int) {
        ...
        serviceScope.launch {
            ...
            if (book != null) {
                com.example.core.LogKeeper.writeLog("eBookReader", "Opened book: ${book.title}")
    ...
    private fun loadChapterText(scrollToBottom: Boolean = false) {
        ...
        serviceScope.launch(Dispatchers.IO) {
            ...
            if (chapterFile.exists()) {
                ...
                withContext(Dispatchers.Main) {
                    com.example.core.LogKeeper.writeLog("eBookReader", "Reading Chapter ${currentChapterIndex + 1}")
                    chapterContent = text
